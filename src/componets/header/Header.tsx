 ...
 useEffect(() => {
  ...
  return (
    <>
          ...
          <Nav className="me-auto">
            ...
            <NavDropdown title="Categorias" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item
                href="#"
                onClick={() => {
                  searchMovie(Genres.War, TypeFilter.Genre, LabelsGenres.War);
                }}
              >
                {LabelsGenres.War}
              </NavDropdown.Item>
            ...
            <NavDropdown title="Streaming" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item
                ...
                onClick={() => {
                  searchMovie(
                    ProvidersStreaming.AmazonPrimeVideo,
                    TypeFilter.Stream,
              ...
              <NavDropdown.Item
                ...
                onClick={() => {
                  searchMovie(
                    ProvidersStreaming.AppleTvPlus,
                    TypeFilter.Stream,
      ...
      {!activeDetailsCard && (
        <div>
          <h5 className="d-flex mt-3 align-items-center justify-content-center text-white p-3">
            {genreDescriptions[type || 0]}
          </h5>
            ...
            {activeFilter.map((button) =>
              button.label ? (
                <Button
                  ...
                  key={button.label}
                  onClick={() => {
                    onRemoveFilter(button);
                  }}
                >
                  {button.label} <CloseButton className="ms-2" />
                </Button>
              ) : null,
            )}
          </div>
